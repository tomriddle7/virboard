...
export default function Streamers() {
  ...
  return (
    <main className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <section className="flex-1 flex flex-col min-h-0 max-w-4xl mx-auto p-4 sm:p-6 pb-20">
